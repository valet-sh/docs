...
See also the *[init](init.md)* command to generate a plain configuration file and the *[Project configuration via .valet-sh.yml](../how-to-articles/project-configuration-via-valet-sh-yml.md)* guide.
